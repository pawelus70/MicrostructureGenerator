...
def generate_mesh():
    ...
    # tworzenie polygonow dla meshu
    #m, n = bin_nums.shape
    # rozmiar obrazu x i y
    m, n = red.shape
    # komponent x
    ...
    filename = os.path.join(file_dir, 'abaqus_input.inp')
    tmesh.write(filename, 'abaqus', None, pmesh)
    # shutil.copy(image_filename, dirs)

    # zapis do pliku z usunieciem wadliwego kodu
